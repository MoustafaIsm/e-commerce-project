...
const totalclienstURL= "http://localhost/e-commerce-project/ecommerce-server/admin-api/get-total-number-of-clients-api.php";
const totalproductsURL = "http://localhost/e-commerce-project/ecommerce-server/admin-api/get-total-number-of-products-api.php";
const totalSellersURL = "http://localhost/e-commerce-project/ecommerce-server/admin-api/get-total-number-of-sellers-api.php";
const bestSellerURL = "http://localhost/e-commerce-project/ecommerce-server/admin-api/get_best_sellers.php";
const bestClientsURL = "http://localhost/e-commerce-project/ecommerce-server/admin-api/get-best-clients-api.php";
let clients_count = 0;
